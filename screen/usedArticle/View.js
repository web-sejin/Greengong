          ...
          {swp.length > 0 ? (
            ...
            <View style={styles.swiper}>
              ...
              {/* <Swiper 
                ...
                onIndexChanged={(curr)=>{setSwpCurr(curr)}}
              >
                {swp.map((item, index) => {
                  return(
                    <TouchableOpacity 
                  ...
                  <View style={styles.listInfoBox}>
                    ...
                    <View style={styles.listInfoPriceBox}>
                      ...
                      <View style={[styles.listInfoPriceArea]}>
                        ...
                        {item2.is_free != 1 && item2.pd_sell_type != 3 ? (
                        <View style={styles.listInfoPrice}>
                          <Text style={styles.listInfoPriceText}>{item2.pd_price}원</Text>
                        </View>
                        ) : null}
                      ...
                      {item2.pd_status_org != 2 && item2.pd_status_org != 3 && item2.pd_sell_type == 3 ? (
                      <View style={[styles.listInfoPriceArea]}>
...
const styles = StyleSheet.create({
  ...
  fixPriceText: {fontFamily:Font.NotoSansBold,fontSize:15,lineHeight:20,color:'#000'},
  ...
  nextBtn4: {width:210,},
	nextBtnText: {fontFamily:Font.NotoSansBold,fontSize:15,lineHeight:58,color:'#fff'},
